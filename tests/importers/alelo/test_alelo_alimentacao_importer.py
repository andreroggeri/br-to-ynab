...
def test_should_import_alimentacao_transactions(fake_card, fake_transactions):
    ...
    importer = AleloAlimentacaoImporter(fake_alelo, '5555')
...
def test_should_raise_exception_if_alimentacao_card_doesnt_exists(fake_card):
    fake_alelo = Mock(Alelo)
